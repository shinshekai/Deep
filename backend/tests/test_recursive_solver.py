...
from app.services.recursive_solver import RecursiveSolver, RecursionRound
...
def test_select_pattern():
    ...
    assert RecursiveSolver.select_pattern("Investigate and compare the effects of X and Y comprehensively.", 0.5, retrieved_chunks=5) == "deliberation"
    
    # Multi-domain -> mixture
    assert RecursiveSolver.select_pattern("Implement a function to calculate the integral using scientific research.", 0.5) == "mixture"
