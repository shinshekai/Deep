...
def sample_pages():
    return [
        ...
        },
        {
            "page_num": 2,
            "text": (
                "Introduction continued with more details.\n"
            ),
        },
        {
            "page_num": 3,
...
def test_structure_tree():
    ...
    gen = PageIndexTreeGenerator(None)
    nodes = [
        {"title": "Intro", "depth": 1, "start_index": 0, "end_index": 100,
         "page_start": 1, "page_end": 5, "summary": "Intro summary"},
        {"title": "Methods", "depth": 1, "start_index": 100, "end_index": 200,
         "page_start": 6, "page_end": 10, "summary": "Methods summary"},
    ]
...
def test_structure_tree_nested():
    ...
    gen = PageIndexTreeGenerator(None)
    nodes = [
        {"title": "Chapter 1", "depth": 1, "start_index": 0, "end_index": 50,
         "page_start": 1, "page_end": 3, "summary": "Ch1 summary"},
        {"title": "Section 1.1", "depth": 2, "start_index": 0, "end_index": 25,
         "page_start": 1, "page_end": 2, "summary": "Sec 1.1 summary"},
        {"title": "Chapter 2", "depth": 1, "start_index": 50, "end_index": 100,
         "page_start": 4, "page_end": 6, "summary": "Ch2 summary"},
    ]
