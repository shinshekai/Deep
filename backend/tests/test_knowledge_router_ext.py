...
from app.routers.knowledge import _process_document, _tasks, _kb_registry
...
async def test_process_document_success(clean_tasks_registry, tmp_path):
    ...
    # Mock extract_text
    with patch("app.routers.knowledge.extract_text", AsyncMock(return_value="Extracted text content")):
        # Mock dependencies
        mock_pg = MagicMock()
