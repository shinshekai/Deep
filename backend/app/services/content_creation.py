...
class NotebookService:
    ...
    def create_notebook(
        self, title: str, description: str = "", device_id: str = ""
    ) -> dict[str, Any]:
    ...
    def add_note(
        self, notebook_id: str, content: str, source: str = "manual", device_id: str = ""
    ) -> dict[str, Any]:
...
class CoWriterService:
    ...
    async def edit_text(
        self, text: str, action: str, instruction: str = "", model_id: str = "Qwen3-1.7B-Q4_K_M"
    ) -> dict:
        ...
        if action == "shorten":
            ...
            return {
                "text": text,
                "provenance": {"action": action, "model": model_id, "sources": []},
            }
    ...
    async def auto_annotate(
        ...
        req = RetrieveRequest(
            query=text, kb_name=kb_name, retrieval_pipeline=retrieval_pipeline, top_k=3
        )
...
class IdeaGenService:
    ...
    async def generate_ideas(
        self, notebook_ids: list[str], model_id: str = "Qwen3-1.7B-Q4_K_M"
    ) -> list[str]:
        # Stage 1: Extraction
        all_notes = ""
