      ...
      {showCreateModal && (
        ...
        >
          <form
            ...
            className="w-full max-w-md rounded-xl border border-zinc-800 bg-zinc-950 p-6 space-y-4 shadow-xl select-none"
          >
            ...
            <div className="flex justify-end gap-2 border-t border-zinc-900 pt-4">
              <button
                type="button"
                onClick={() => setShowCreateModal(false)}
                className="rounded-lg border border-zinc-850 px-4 py-1.5 text-xs font-semibold text-zinc-400 hover:bg-zinc-900 transition"
              >
                Cancel
              </button>
              <button
                ...
                className="flex items-center gap-1.5 rounded-lg bg-indigo-600 px-4 py-1.5 text-xs font-semibold text-white hover:bg-indigo-500 transition disabled:opacity-40"
              >
                {isCreatingNb ? (
                  <>
                    <Loader2 className="h-3.5 w-3.5 animate-spin" />
